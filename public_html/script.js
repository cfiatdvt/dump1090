...
//Start CJS Add
        ...
        // New 2018 depature procedures ZEPER1, QUAKY1, MRBIL1, FORPE1
        var ZOLUPwpt = setwaypointFunction("ZOLUP", 33.429, -112.068); 
        var YOVKUwpt = setwaypointFunction("YOVKU", 33.433, -112.197); 
        var ZIDOGwpt = setwaypointFunction("ZIDOG", 33.531, -112.196, -8, 6); 
        var FANONwpt = setwaypointFunction("FANON", 33.625, -112.204, -8, 6); 
        var ZEPERwpt = setwaypointFunction("ZEPER", 34.028, -112.335,-20,6,"1");
        var MAYSAwpt = setwaypointFunction("MAYSA", 34.562, -112.875, -8,5);
        ...
        var FORPEwpt = setwaypointFunction("FORPE", 33.687, -111.268,14,8,"1");
        var LALUZwpt = setwaypointFunction("LALUZ", 34.055, -110.216);
        var MRBILwpt = setwaypointFunction("MRBIL", 34.00, -111.60,22,5, "1");
        var YOTESwpt = setwaypointFunction("YOTES", 34.625, -111.119,12,4);
        ...
        TransitionFeatures.push(ZEPERwpt);
        TransitionFeatures.push(MAYSAwpt);
        TransitionFeatures.push(QUAKYwpt);
        TransitionFeatures.push(SNOBLwpt);
        TransitionFeatures.push(CARTLwpt);
        TransitionFeatures.push(FORPEwpt);
        TransitionFeatures.push(LALUZwpt);
        TransitionFeatures.push(MRBILwpt);
        TransitionFeatures.push(YOTESwpt);
        var ZEPER11 = new ol.geom.LineString();
        var ZEPER21 = new ol.geom.LineString();
        var ZEPER31 = new ol.geom.LineString();
        var QUAKY11 = new ol.geom.LineString();
        var QUAKY21 = new ol.geom.LineString();
        var QUAKY31 = new ol.geom.LineString();
        var MRBIL11 = new ol.geom.LineString();
        var MRBIL21 = new ol.geom.LineString();
        var MRBIL31 = new ol.geom.LineString();
        var FORPE11 = new ol.geom.LineString();
        var FORPE21 = new ol.geom.LineString();
        var FORPE31 = new ol.geom.LineString();
        ...
        ZEPER21.appendCoordinate(ol.proj.transform(GOALYwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        ZEPER21.appendCoordinate(ol.proj.transform(GOLDRwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        ZEPER21.appendCoordinate(ol.proj.transform(ZEPERwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        ZEPER31.appendCoordinate(ol.proj.transform(ZEPERwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        ZEPER31.appendCoordinate(ol.proj.transform(MAYSAwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        QUAKY11.appendCoordinate(ol.proj.transform(ZIDOGwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        QUAKY11.appendCoordinate(ol.proj.transform(OXYGNwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        QUAKY11.appendCoordinate(ol.proj.transform(ZILUBwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        QUAKY11.appendCoordinate(ol.proj.transform(QUAKYwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        QUAKY21.appendCoordinate(ol.proj.transform(GOALYwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        QUAKY21.appendCoordinate(ol.proj.transform(QUAKYwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        QUAKY31.appendCoordinate(ol.proj.transform(QUAKYwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        QUAKY31.appendCoordinate(ol.proj.transform(SNOBLwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        QUAKY31.appendCoordinate(ol.proj.transform(CARTLwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        MRBIL11.appendCoordinate(ol.proj.transform(ZILUBwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        MRBIL11.appendCoordinate(ol.proj.transform(MRBILwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        MRBIL21.appendCoordinate(ol.proj.transform(GOALYwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        MRBIL21.appendCoordinate(ol.proj.transform(POCCKwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        MRBIL21.appendCoordinate(ol.proj.transform(MRBILwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        MRBIL31.appendCoordinate(ol.proj.transform(MRBILwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        MRBIL31.appendCoordinate(ol.proj.transform(YOTESwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        FORPE11.appendCoordinate(ol.proj.transform(ZILUBwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        FORPE11.appendCoordinate(ol.proj.transform(FORPEwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        FORPE31.appendCoordinate(ol.proj.transform(FORPEwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        FORPE31.appendCoordinate(ol.proj.transform(LALUZwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        FORPE31.appendCoordinate(ol.proj.transform(SJNvor.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        var ZEPER11ln = setpathFunction(ZEPER11, SIDStyle);
        var ZEPER21ln = setpathFunction(ZEPER21, SIDStyle);
        var ZEPER31ln = setpathFunction(ZEPER31, SIDStyle);
        var QUAKY11ln = setpathFunction(QUAKY11, SIDStyle);
        var QUAKY21ln = setpathFunction(QUAKY21, SIDStyle);
        var QUAKY31ln = setpathFunction(QUAKY31, SIDStyle);
        var MRBIL11ln = setpathFunction(MRBIL11, SIDStyle);
        var MRBIL21ln = setpathFunction(MRBIL21, SIDStyle);
        var MRBIL31ln = setpathFunction(MRBIL31, SIDStyle);
        var FORPE11ln = setpathFunction(FORPE11, SIDStyle);
        var FORPE31ln = setpathFunction(FORPE31, SIDStyle);
        WestFlowFeatures.push(ZEPER11ln);
        WestFlowFeatures.push(QUAKY11ln);
        WestFlowFeatures.push(MRBIL11ln);
        WestFlowFeatures.push(FORPE11ln);
        EastFlowFeatures.push(ZEPER21ln);
        EastFlowFeatures.push(QUAKY21ln);
        EastFlowFeatures.push(MRBIL21ln);
        TransitionFeatures.push(ZEPER31ln);
        TransitionFeatures.push(QUAKY31ln);
        TransitionFeatures.push(MRBIL31ln);
        TransitionFeatures.push(FORPE31ln);


        // New 2018 depature procedures BROAK1, ECLPS1, STRRM1, FYRBD1, KEENS2 
        var INT02wpt = setwaypointFunction("INT02", 33.431, -112.046); 
        var JUTAKwpt = setwaypointFunction("JUTAK", 33.392, -112.191); 
        var WETALwpt = setwaypointFunction("WETAL", 33.291, -112.155); 
        var RIICHwpt = setwaypointFunction("RIICH", 33.24, -112.095, 0, 6); 
        var PYPPEwpt = setwaypointFunction("PYPPE", 33.26, -111.932, 0, 6); 
        var BARLLwpt = setwaypointFunction("BARLL", 33.427, -111.549, 0, 6); 
        var BROAKwpt = setwaypointFunction("BROAK", 33.53, -111.22,10,10,"1");
        var FTHLSwpt = setwaypointFunction("FTHLS", 33.768, -110.364,10,6);
        var JNIPRwpt = setwaypointFunction("JNIPR", 34.03, -109.32);
        var STRRMwpt = setwaypointFunction("STRRM", 32.886, -111.909, -20, 14, "1"); 
        var FYRBDwpt = setwaypointFunction("FYRBD", 32.956, -112.674, -26, -6, "1"); 
        ...
        var JUDTHwpt = setwaypointFunction("JUDTH", 32.816, -113.68,10,8);
        var MOHAKwpt = setwaypointFunction("MOHAK", 32.776, -113.971,4,4);
        var FUTEPwpt = setwaypointFunction("FUTEP", 33.434, -111.87);
        var AZCRDwpt = setwaypointFunction("AZCRD", 33.394, -111.837);
        var USEYEwpt = setwaypointFunction("USEYE", 33.35, -111.868);
        var MASVEwpt = setwaypointFunction("MASVE", 33.355, -111.919);
        var OAKLIwpt = setwaypointFunction("OAKLI", 33.364, -112.014);
        var IZZZOwpt = setwaypointFunction("IZZZO", 33.45, -112.80, 0, 8); 
        ...
        var ECLPSwpt = setwaypointFunction("ECLPS", 33.07, -111.45,22,-6, "1");
        var KATMNwpt = setwaypointFunction("KATMN", 32.64, -110.67);
        ...
        var BNYRDwpt = setwaypointFunction("BNYRD", 32.998, -111.966);
        ...
        TransitionFeatures.push(BROAKwpt);
        TransitionFeatures.push(FTHLSwpt);
        TransitionFeatures.push(JNIPRwpt);
        TransitionFeatures.push(FYRBDwpt);
        TransitionFeatures.push(JUDTHwpt);
        TransitionFeatures.push(MOHAKwpt);
        TransitionFeatures.push(WULKOwpt);
        TransitionFeatures.push(KEENSwpt);
        TransitionFeatures.push(IZZZOwpt);
        ...
        TransitionFeatures.push(ECLPSwpt);
        TransitionFeatures.push(KATMNwpt);
        TransitionFeatures.push(BOXXRwpt);
        TransitionFeatures.push(BNYRDwpt);
        TransitionFeatures.push(STRRMwpt);

        var BROAK11 = new ol.geom.LineString();
        var BROAK21 = new ol.geom.LineString();
        var BROAK31 = new ol.geom.LineString();
...
//        BROAK21.appendCoordinate(ol.proj.transform(SPRKYwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
//        BROAK21.appendCoordinate(ol.proj.transform(BROAKwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        BROAK31.appendCoordinate(ol.proj.transform(BROAKwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        BROAK31.appendCoordinate(ol.proj.transform(FTHLSwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        BROAK31.appendCoordinate(ol.proj.transform(JNIPRwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        var BROAK11ln = setpathFunction(BROAK11, SIDStyle);
//        var BROAK21ln = setpathFunction(BROAK21, SIDStyle);
        var BROAK31ln = setpathFunction(BROAK31, SIDStyle);
        WestFlowFeatures.push(BROAK11ln);
//        EastFlowFeatures.push(BROAK21ln);
        TransitionFeatures.push(BROAK31ln);

        var ECLPS11 = new ol.geom.LineString();
        var ECLPS21 = new ol.geom.LineString();
        var ECLPS31 = new ol.geom.LineString();
        ...
        ECLPS31.appendCoordinate(ol.proj.transform(ECLPSwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        ECLPS31.appendCoordinate(ol.proj.transform(KATMNwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        ECLPS31.appendCoordinate(ol.proj.transform(BOXXRwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        var ECLPS11ln = setpathFunction(ECLPS11, SIDStyle);
        var ECLPS31ln = setpathFunction(ECLPS31, SIDStyle);
        WestFlowFeatures.push(ECLPS11ln);
        TransitionFeatures.push(ECLPS31ln);

        var STRRM11 = new ol.geom.LineString();
        var STRRM21 = new ol.geom.LineString();
        var STRRM31 = new ol.geom.LineString();
        STRRM11.appendCoordinate(ol.proj.transform(JUTAKwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        STRRM11.appendCoordinate(ol.proj.transform(WETALwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        STRRM11.appendCoordinate(ol.proj.transform(BNYRDwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        STRRM21.appendCoordinate(ol.proj.transform(ANZELwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        STRRM21.appendCoordinate(ol.proj.transform(DDUKEwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        STRRM21.appendCoordinate(ol.proj.transform(BNYRDwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        STRRM31.appendCoordinate(ol.proj.transform(BNYRDwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        STRRM31.appendCoordinate(ol.proj.transform(STRRMwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        STRRM31.appendCoordinate(ol.proj.transform(TUSvor.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        var STRRM11ln = setpathFunction(STRRM11, SIDStyle);
        var STRRM21ln = setpathFunction(STRRM21, SIDStyle);
        var STRRM31ln = setpathFunction(STRRM31, SIDStyle);
        WestFlowFeatures.push(STRRM11ln);
        EastFlowFeatures.push(STRRM21ln);
        TransitionFeatures.push(STRRM31ln);

        var FYRBD11 = new ol.geom.LineString();
        var FYRBD21 = new ol.geom.LineString();
        var FYRBD31 = new ol.geom.LineString();
        FYRBD11.appendCoordinate(ol.proj.transform(OAKLIwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        FYRBD11.appendCoordinate(ol.proj.transform(FYRBDwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        FYRBD21.appendCoordinate(ol.proj.transform(WETALwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        FYRBD21.appendCoordinate(ol.proj.transform(FYRBDwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        FYRBD31.appendCoordinate(ol.proj.transform(FYRBDwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        FYRBD31.appendCoordinate(ol.proj.transform(JUDTHwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        FYRBD31.appendCoordinate(ol.proj.transform(MOHAKwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        var FYRBD11ln = setpathFunction(FYRBD11, SIDStyle);
        var FYRBD21ln = setpathFunction(FYRBD21, SIDStyle);
        var FYRBD31ln = setpathFunction(FYRBD31, SIDStyle);
        EastFlowFeatures.push(FYRBD11ln);
        WestFlowFeatures.push(FYRBD21ln);
        TransitionFeatures.push(FYRBD31ln);

        var KEENS11 = new ol.geom.LineString();
//        var KEENS21 = new ol.geom.LineString();
        var KEENS31 = new ol.geom.LineString();
        var KEENS41 = new ol.geom.LineString();
        var KEENS51 = new ol.geom.LineString();
        KEENS11.appendCoordinate(ol.proj.transform(FUTEPwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        KEENS11.appendCoordinate(ol.proj.transform(AZCRDwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        KEENS11.appendCoordinate(ol.proj.transform(USEYEwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        KEENS11.appendCoordinate(ol.proj.transform(MASVEwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        KEENS11.appendCoordinate(ol.proj.transform(OAKLIwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        KEENS11.appendCoordinate(ol.proj.transform(WULKOwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        KEENS31.appendCoordinate(ol.proj.transform(WULKOwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        KEENS31.appendCoordinate(ol.proj.transform(KEENSwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        KEENS31.appendCoordinate(ol.proj.transform(IZZZOwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        KEENS31.appendCoordinate(ol.proj.transform(MESSIwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        KEENS41.appendCoordinate(ol.proj.transform(IZZZOwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        KEENS41.appendCoordinate(ol.proj.transform(CULTSwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        KEENS41.appendCoordinate(ol.proj.transform(HRRBRwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        KEENS51.appendCoordinate(ol.proj.transform(IZZZOwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        KEENS51.appendCoordinate(ol.proj.transform(SALOMwpt.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        KEENS51.appendCoordinate(ol.proj.transform(BLHvor.getGeometry().getCoordinates(), 'EPSG:3857', 'EPSG:4326'));
        var KEENS11ln = setpathFunction(KEENS11, SIDStyle);
//        var KEENS21ln = setpathFunction(KEENS21, SIDStyle);
        var KEENS31ln = setpathFunction(KEENS31, SIDStyle);
        var KEENS41ln = setpathFunction(KEENS41, SIDStyle);
        var KEENS51ln = setpathFunction(KEENS51, SIDStyle);
        EastFlowFeatures.push(KEENS11ln);
//        WestFlowFeatures.push(KEENS21ln);
        TransitionFeatures.push(KEENS31ln);
        TransitionFeatures.push(KEENS41ln);
        TransitionFeatures.push(KEENS51ln);
        ...
        var HOMRRwpt = setwaypointFunction("HOMRR",33.88, -111.41,12,4);
