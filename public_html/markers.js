...
function svgPathToURI(path, stroke, fill, selected_stroke) {
    var tempstring = svgPathToSvg(path, stroke, fill, selected_stroke);
    var tempstring2 = "data:image/svg+xml;base64," + btoa(tempstring);
    return tempstring2;
}
